    ...
    public class HaravanAPIAuthorizer
    {
        ...
        public HaravanAPIAuthorizer(string shopName, string apiKey, string secret, string redirectUrl)
        {
            ...
            if (shopName.Contains("."))
                throw new ArgumentException("make sure that the shop name parameter is the only the subdomain part of the myharavan.com url.", "shopName");
        ...
        {
            string url = String.Format("https://{0}.myharavan.com/admin/oauth/access_token", _shopName);
